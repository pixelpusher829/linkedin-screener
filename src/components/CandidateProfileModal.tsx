...
const SCORE_WEIGHT_FIELDS = [
	...
	{ key: "designSignals", label: "Design/UX signal" },
	{ key: "missingDesignSignals", label: "No design signal" },
	{ key: "heavyEngineering", label: "Heavy engineering" },
	{ key: "strictEducation", label: "Strict education" },
	{ key: "salaryAbove", label: "Salary above floor" },
	{ key: "salaryWithin", label: "Salary near floor" },
	{ key: "salaryBelow", label: "Salary below floor" },
	{ key: "requiredSkill", label: "Required skill" },
	{ key: "niceSkill", label: "Bonus skill" },
] as const;
						...
						<div className="space-y-6">
							...
							<div className="p-4 rounded-xl bg-slate-950/40 border border-slate-800/80 space-y-4">
								...
								<div className="space-y-2">
									<label className="font-semibold text-slate-200 flex items-center justify-between">
										<span className="text-emerald-400 font-bold">
											Required Core Tech Stack (High Weight)
										</span>
										<span className="text-[11px] text-slate-500">
